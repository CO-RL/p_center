...
def generate_samples(filepath, k, out_dir):
    ...
    for file in filepath:
        ...
        feature = extract_features(G, pos=pos)
...
if __name__ == '__main__':
    ...
    generate_samples(filepath=instances_graph, k=args.ncenter, out_dir=out_dir)
